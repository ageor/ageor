...
function startWatching() {
  fs.watch('./hardly/components/', { recursive: true }, triggerBuild());
  fs.watch('./hardly/systems/', { recursive: true }, triggerBuild());
  fs.watch('./hardly/prototype/', { recursive: true }, triggerBuild());
  fs.watch('./hardly/importers/', { recursive: true }, triggerBuild());
  fs.watch('./hardly/utils/', { recursive: true }, triggerBuild());
  fs.watch('./hardly/config.js', { }, triggerBuild());
}
