...
Flw.Leaf.prototype = {
    ...
    drawFromTo : function( context , t1 , t2 ){
        ...
        if( r < 0.99 ){
            var rr = ( r - 0.7 ) / 0.3;
            var sinr = Math.cos( rr * 3 * Math.PI * 0.1 ) * 0.3 * ( 1 - rr ) + 1;
            var radius = this._radius;
            var d = this._d * ( Math.cos( rr * 1 * Math.PI * 0.1 ) * 0.005 * ( 1 - rr ) + 1 );
            o = {
                x : this._o.x + Math.cos( d ) * 1 * ( sinr - 1 ),
                y : this._o.y + Math.sin( d ) * 1 * ( sinr - 1 )
            };
            pic = {
                x : o.x + Math.cos( d ) * radius,
                y : o.y + Math.sin( d ) * radius
...
Flw.Petal.prototype = {
    ...
    drawFromTo : function( context , t1 , t2 ){
        ...
        if( r < 0.99 ){
            ...
            var rr = ( r - 0.70 ) / 0.30;
            var sinr = Math.cos( rr * Math.PI * 0.1 ) * 0.03 * ( 1 - rr ) + 1;
            o = this._o;
...
Flw.LimitedFlower.prototype = {
    ...
    init : function( divElement , option , run ){
        ...
        staticCanvas.width = this._canvasWidth * 2;
        staticCanvas.height = this._canvasHeight * 2;
        ...
        dynamicCanvas.width = this._canvasWidth * 2;
        dynamicCanvas.height = this._canvasHeight * 2;
